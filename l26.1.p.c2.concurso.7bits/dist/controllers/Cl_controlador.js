...
(_a = document.getElementById("v_btnProcesar")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
    const n = new Cl_mConcursante(vAspirante.nombre, vAspirante.apellido, vAspirante.cedula, vAspirante.sexo, vAspirante.fecha, vAspirante.indice, vAspirante.prep, vAspirante.dip);
